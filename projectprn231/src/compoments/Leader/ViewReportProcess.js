...
export class ViewReportProcess extends Component {
    ...
    render() {
        ...
        const { ListReport, activePage, itemsCountPerPage, totalItemsCount } = this.state;

        const indexOfLastCustomer = activePage * itemsCountPerPage;
        const indexOfFirstCustomer = indexOfLastCustomer - itemsCountPerPage;
        const currentCustomers = ListReport.slice(indexOfFirstCustomer, indexOfLastCustomer);

        return (
            <div className="contanier">
                <section className="panel tasks-widget">
                    <header className="panel-heading">
                        <h2>List ReportProccess</h2>
                    </header>
                </section>
                <div>
