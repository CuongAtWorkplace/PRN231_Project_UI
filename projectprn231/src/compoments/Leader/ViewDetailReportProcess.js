...
class ViewDetailReportProcess extends Component {
    ...
    refreshList() {
        ...
        fetch("https://localhost:7248/api/ReportTask/GetReportTaskByTaskId?taskId=" + id)
            .then(response => response.json())
            .then(data => {
                this.setState({ ReportTaskById: data, Title: data.title , Description: data.description, Content: data.content, CreateDate: data.createDate, CreateBy: data.user.fullName, Id: data.id });
            });
                        ...
                        <div class="panel-body">
                            <form>
                                ...
                                <div className="form-group">
                                    ...
                                    <input name="ProductPrice" value={Title} class="form-control" />
                                </div>
